package org.stlife.code.gen.service.impl;
...
import org.stlife.code.gen.utils.CodeGenUtil;
import org.stlife.code.gen.utils.DbUtil;
...
public class CodeGenServiceImpl implements CodeGenService {
    ...
    public byte[] generatorCode(GenConfig genConfig) {
        ...
        List<TableRequest> tableList = genConfig.getTables();
        for (TableRequest each: tableList) {
            //查询表信息
            Entity table = queryTable(each);
            //查询列信息
            List<Entity> columns = queryColumns(each);
            //生成代码
